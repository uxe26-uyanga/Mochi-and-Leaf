...
Shader "Luceed Studio/URP Stylized Combined"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord145_g22 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 UV151_g22 = texCoord145_g22;
				float3 ase_normalWS = input.ase_texcoord6.xyz;
				float3 normalizedWorldNormal = normalize( ase_normalWS );
				float3 normalizeResult137_g22 = normalize( ( _MainLightPosition.xyz + WorldViewDirection ) );
				float dotResult141_g22 = dot( normalizedWorldNormal , normalizeResult137_g22 );
				...
				float3 tanNormal102_g22 = normalizedWorldNormal;
				float3 bakedGI102_g22 = ASEIndirectDiffuse( input, float3( dot( tanToWorld0, tanNormal102_g22 ), dot( tanToWorld1, tanNormal102_g22 ), dot( tanToWorld2, tanNormal102_g22 ) ) );
				MixRealtimeAndBakedGI( ase_mainLight, float3( dot( tanToWorld0, tanNormal102_g22 ), dot( tanToWorld1, tanNormal102_g22 ), dot( tanToWorld2, tanNormal102_g22 ) ), bakedGI102_g22, half4( 0, 0, 0, 0 ) );
				float3 lerpResult40_g22 = lerp( temp_cast_1 , bakedGI102_g22 , _IndirectDiffuseContribution);
				float temp_output_31_0_g22 = ( 1.0 - _MainLightPosition.w );
				float4 temp_cast_4 = (temp_output_31_0_g22).xxxx;
				float dotResult10_g22 = dot( normalizedWorldNormal , _MainLightPosition.xyz );
				...
				float dotResult38_g22 = dot( normalizedWorldNormal , WorldViewDirection );
...
WireConnection;107;2;92;0
ASEEND*/
//CHKSM=B1CB2B9FA139D2E3D8AA882EB8DF47823BD1BACB